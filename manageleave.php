...
include_once 'add-leave.php';
 ...
 $result = mysqli_query($conn,"SELECT * FROM aleave ");
           ...
           <ul>
             <li>
              ...
              <!-- <li>
               ...
               <!--<li>
                   <a href="travel.php"><span class="fa fa-file-invoice"></span>
                   <span>Travel Request</span></a>    
               </li>
                <li>
  ...
  <div class="container">
   <div class="table-wrapper">
    <div class="table-title">
	  <div class="row">
	      <div class="col-sm6">
		         <a href="#add-requision.php" class="btn btn-success" onclick='openForm()'><i class="fa fa-plus"></i> Add leave</a>
			     ...
			     <?php 
				   ...
				   <tr>
			         ...
			         <td>
                      ...
                      <a href="decline-leave.php?leaveid=<?php echo $row['leaveid']; ?>" class="btn btn-danger" id="delete" style="color:white;" >Delete</a>
